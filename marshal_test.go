...
func TestMarshal(t *testing.T) {
	...
	assert.Equal(t, "IPv4StringToNum('192.0.2.128')", marshal(FuncHandle{Func: "IPv4StringToNum", Data: "192.0.2.128"}))
	assert.Equal(t, "IPv4NumToString(3221225985)", marshal(FuncHandle{Func: "IPv4NumToString", Data: 3221225985}))
